...
% \begin{notes}
%     \begin{itemize}
%         \item Problems: unreliable information, information from untrustworthy
%               or non-expert sources
%         \item We look at aggregating information, assessing the trustworthiness
%               of sources and reasoning about expertise.
%         \item Two core goals: find the \emph{truth}, and to aggregate
%               \emph{rationally}.
%         \item In the first part we use methodology of social choice theory
%               by taking an \emph{axiomatic approach}, where normative properties
%               of aggregation methods (called \emph{axioms}) are introduced, and
%               their interactions and consequences studied. Insights about
%               specific aggregation methods can be obtained by seeing which
%               axioms hold.
%         \item In the second part we take a logic-based perspective, including a
%               modal logic framework to reason about expertise,
%               and another look at the aggregation problem through the lens of
%               rational belief change.
%         \item The results which will be presented are of a conceptual -- and
%               sometimes technical -- nature.
%         \item It is hoped that our formal approach elucidates interesting
%               properties of the problem and possible solution methods. These
%               properties may be considered in subsequent practical
%               applications.
%     \end{itemize}
% \end{notes}
