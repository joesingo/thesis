...
\begin{proof}\leavevmode
    \begin{enumerate}
        \item Suppose $\tuple{i, c, \phi} \in \sigma$. First suppose
          ...
          \item Take $\tuple{i, c, \phi} \in \sigma$. We consider cases again.
                The case $\neg(\E_i\phi \land \phi) \in B^\sigma_c$ is the same
                as above, needing only the basic postulates to show
                $\neg\E_i\phi \in B^\sigma_c$.

                Suppose $\neg(\E_i\phi \land \phi) \notin B^\sigma_c$. We aim
                to show $\phi \in B^\sigma_c$. Without loss of generality,
                suppose $B^\sigma$ is consistent. Now,
                \strongcondsucc{} gives $\phi \in B^{\sigma \concat \tuple{i,
                c, \phi}}_c$. By \incvac{},
                \[
                    B^{\sigma \concat \tuple{i, c, \phi}}
                    \sqsubseteq \cn(B^\sigma \sqcup K^{\tuple{i, c, \phi}}),
                \]
                with equality if the right-hand side is consistent. Since
                $B^\sigma$ is consistent, there is some $W \in
                \mods(B^\sigma)$. Recall that \kconj{} -- which follows from
                the basic postulates -- implies that knowledge is monotonic.
                The fact that $\tuple{i, c, \phi} \in \sigma$ consequently
                implies $K^{\tuple{i, c, \phi}} \sqsubseteq K^\sigma$.
                Appealing also to \containment{}, we get $K^{\tuple{i, c,
                \phi}} \sqsubseteq B^\sigma$. Thus
                \[
                    \cn(B^\sigma \sqcup K^{\tuple{i, c, \phi}})
                    = \cn(B^\sigma)
                    = B^\sigma
                \]
                which is consistent by assumption. Consequently, \incvac{}
                gives $B^{\sigma \concat \tuple{i, c, \phi}} = \cn(B^\sigma
                \sqcup K^{\tuple{i, c, \phi}}) = B^\sigma$. In particular,
                we get $\phi \in B^\sigma_c$ as desired.
    \end{enumerate}
\end{proof}
...
imply $\Delta_\mu(\Phi) \vdash \mu$ -- the \axiomref{IC0} postulate of
