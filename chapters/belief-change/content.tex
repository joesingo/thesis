...
$
i.e. the propositional parts of $G$ are (classically) closed. \todo{Richard
wants to see a proof of this.}
...
simple conditioning. From Richard: ``I would. It yields a version of Darwiche
and Pearl’s C1 but for ordinary sources, so it’s good to link with DP. It’s
going in the journal version, in any case. If you include Cancellation it might
be worth pointing out that it is a strengthening of Duplicate-removal (given
