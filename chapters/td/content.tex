...
trustworthy sources are those that report believable claims. Application areas
include real-time traffic navigation~\cite{du2019}, drug side-effect
discovery~\cite{ma2017}, crowdsourcing and social
...
With this in mind, we develop a simplified framework for truth discovery in
...
\emph{TruthFinder}~\cite{yin_supervised_2011} and \emph{CRH}~\cite{li2016}, and
...
\todo{Contributions and publication statement.}
...
\todo{Lead into tournament stuff, and prepare reader for logic-based analogue
of truth discovery in the second half.}
