...
show in \cref{td_new_sec_consequences_and_impossibilities} that it is
...
makes $c$ \emph{strictly} more believable in the new network.
%
...
somewhat trivial case, it will turn out to be useful in axiomatically c
haracterising voting in \todo{section reference}. It can be seen as one of the
many generalisations of \emph{May's Theorem}~\cite{may1952set}, which
characterises the majority voting rule in two-candidate elections.
%
...
\footnotetext{
    ...
    \emph{different} objects in \todo{section reference}.
}
...
\begin{theorem}
    The following axioms cannot hold simultaneously:
    \begin{enumerate}
        \item \claimcoherence{}, \symmetry{}, \freshposresp, \sourceposresp{}
            and \classicalindependence{}.
        \item \claimcoherence{}, \symmetry{}, \freshposresp, \sourcecoherence{}
            and \classicalindependence{}.
    \end{enumerate}
\end{theorem}
...
\section{Consequences and Impossibilities}
\label{td_new_sec_consequences_and_impossibilities}
