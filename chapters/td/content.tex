...
\begin{definition}
    ...
    \]
    The limit operator is denoted by $\crh{\epsilon}$.
\end{definition}
...
\footnotetext{
    ...
    a unit eigenvector of $M^{\text{T}}M$. \todo{possibly signpost that we also
    take linear algebra approach for unbounded sums?}
}
...
without these deficiencies in \todo{section reference}.
