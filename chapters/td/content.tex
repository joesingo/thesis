...
drug side-effect discovery~\cite{ma2017}, and crowdsourcing and social
...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption[
        Illustrative example of a truth discovery problem.
    ]{
...
voting theory~\cite{zwicker2016voting} and ranking and recommendation
...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption[
        Claim-centric presentation of the illustrative problem.
    ]{
...
\footnotetext{
    A total preorder is a transitive, reflexive and complete binary relation.
}
...
\begin{table}
    \centering
    \caption[Output rankings of example truth discovery operators.]{
        Output rankings of the example operators on the network from
...
with one \emph{medium} source versus a claim $d$ with a \emph{low} and a
...
\axiomref{Anonymity}, which expressed symmetry with respect to voters: if
voters $i$ and $j$ swap their ballots, the election result remains the same.
\axiomref{Neutrality} expresses symmetry with respect to candidates: if we
...
In the context of voting, positive responsiveness requires that a voter
...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption[
        Networks illustrating \freshposresp{} and \sourceposresp{}.
    ]{
...
intuitively weaker than $d$ because of the way in which their respective
sources interact with other claims in the network. Nevertheless, we state this
axiom as a point of comparison with classical social choice problems such as
voting.
...
\begin{theorem}
    ...
    Suppose an operator satisfies \symmetry{}, \claimcoherence{} and
...
\disjointindependence{} also has a natural graphical interpretation. For any
...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption{
        Network illustrating the impossibility results of
