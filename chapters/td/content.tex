...
The second axiom says that object play no role: it is only the relation between
sources and claims which affects the rankings. That is, claims are treated as
atomic elements without considering the conflict relation. To define the
axiom we introduce a notion of ``reducing'' the objects of a network.
...
information affects the rankings. Voting does not use this information,
however, which leads to the following axiom.
