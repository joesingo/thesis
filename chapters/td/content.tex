...
\todo{Mention that we skip CRH and TruthFinder, for simplicity.}
...
To summarise this section, \cref{td_new_tab_axiom_satisfaction} shows which
axioms are satisfied by each operator.
