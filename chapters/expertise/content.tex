...
\begin{figure}
    ...
    \begin{tikzpicture}[scale=1.9]
        ...
        \draw[expertiseset]
            ...
            -- (-\px, 3*\h + \py*\s) -- cycle;
        \node[color=red,anchor=east] at (-\px, 0.5*\h) {$\|p\|$};
        \node[color=red,anchor=east] at (-\px, 2.5*\h) {$\|\neg p\|$};
        ...
        \node[color=blue,anchor=west] at (\w + \px, \h) {$\|p \land \neg d\|$};
    ...
    \caption{
        ...
        formalises \cref{exp_ex_economist_motivation}. \todo{Make this
        consistent with figures in later chapters, and use bar notation.}
    }
...
\textbf{KT45} instead of \textbf{KT5}. S5 is therefore \emph{stronger} than
S4, in the sense that any formula provable in S4 is also provable in S5.
