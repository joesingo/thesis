...
tournament at each stage of the iteration. This may lead to
\emph{difficulty-aware} truth discovery methods (c.f. \textcite{galland2010}).

\todo{From Richard: ``It would be nice if, at the end of this chapter, you
actually gave an example of how you could use the methods of this chapter to
define a recursive TD operator. I guess this might be too difficult, though.
But even just a definition of an operator, plus an example (i.e., without
investigating its properties) would be ok.''}
...
\todo{Consider giving examples for all the axioms.}
...
function~\cite{zwicker2016voting} -- would satisfy \anon{}. \todo{Consider
exaplaining in more detail.} The other axioms
