...
\begin{proof}
    ...
    (\labelcref{tourn_item_int_lemma_dual}), $\phicardint$ satisfies
    \dualaxiom{}.
...
\end{proof}
Note that \anon{} \emph{is} satisfied. This makes $\phicardint$ an
...
Note that \argmaxaxiom{} does \emph{not} require $\ale_K^\phi$ to reduce to
...
\begin{proof}
    ...
    operator with \smi{} (by \Cref{tourn_result_phicardint_smi}).
